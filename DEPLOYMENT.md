...
Deployment: dpl_EVAwq5yYAHwyX5AQk6Qgxpw7Qi35 (Ready, production).
Inspector: https://vercel.com/jon-2e6e/baseball-brain/EVAwq5yYAHwyX5AQk6Qgxpw7Qi35
...
Published source is recorded on refresh/aviators-cutoff-lab with the database-traffic optimization. GitHub PR #1 remains the review record. Deployment is a source upload, not automatic Git integration.
...
Compact decks and server-side JSON extraction reduce per-request transfer. Existing full-deck games and stored scores are preserved. No database migration is required.
